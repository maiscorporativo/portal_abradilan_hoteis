            ...
            <div className="relative max-w-[1400px] mx-auto px-6 py-16">
                <Reveal className="flex flex-col items-center text-center gap-5">
                    ...
                    <div className="flex gap-3 pt-1">
                        <a href="https://www.instagram.com/maiscorporativo/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-neutral-400 hover:text-[#F78A2D] hover:border-[#F78A2D]/40 hover:bg-[#F78A2D]/5 transition-all">
                            <Instagram size={16} />
                        </a>
                    </div>
                </Reveal>
